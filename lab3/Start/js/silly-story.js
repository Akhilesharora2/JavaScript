...
*/
insertX=['Santa' , 'Johny' , 'Robin'];
insertY=['Cundles Plaza' , 'Dukworth Plaza' , 'Grove st.'];
insertZ=['evaporated' , 'sublimented' , 'Scared'];
// FUNCTIONS
...
newStory = newStory.replace(':insertz:', zItem);
	...
	// newStory='It was 94 farenheit outside, so'+ xItem+' went for a walk. When they got to '+yItem+', they stared in horror for a few moments, then '+zItem+'. '+ customName+' saw the whole thing, but he was not surprised — '+xItem +'eighs 300 pounds, and it was a hot day.';
...
story.insertAdjacentHTML("afterend",newStory+"<br><hr><br>");
